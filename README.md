...
<p align="center">
<img src="https://skillicons.dev/icons?i=html,css,js,bootstrap,react,nodejs,npm,php,laravel,c,cpp,arduino,raspberrypi,java,python,mysql,sqlite,bash,md,git,github,vscode,anaconda,androidstudio,pycharm,stackoverflow,wireshark,linux,debian,ubuntu,windows&perline=13"width="85%"/> 
</p>
</br>
