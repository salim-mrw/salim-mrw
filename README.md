...
<p align="center">
<img src="https://skillicons.dev/icons?i=html,css,js,bootstrap,react,nodejs,npm,php,laravel,c,cpp,arduino,raspberrypi,java,python,mysql,sqlite,bash,md,git,github,vscode,stackoverflow,linux,debian,ubuntu,windows,anaconda,androidstudio,pycharm,intljidea&perline=13"width="85%"/> 
</p>
</br>
